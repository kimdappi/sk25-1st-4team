...
### 🚗 Car-Topia
최적의 차량을 추천하는 공간, Car Topia에 오신 것을 환영합니다! 🐰🦊🦊🐹🦁
...
- 최적화: 내부 연산 포맷을 **Pickle(.pkl)**로 전환하여 인코딩 오류 방지  </br>
...
> **조민서** :  열정적인 팀원들과의 활발한 소통과 효율적인 역할 분담 덕분에, 복잡한 데이터 구축 과정을 차질 없이 마칠 수 있었으며, 팀원들과 함께 고민하며 협업의 중요성을 배운 값진 시간이었습니다.   </br>
